...
- Poll status: `pass`; age=`6.6` sec; new orders=`0`
...
- Dynamic sizing: score=`64` clip=`40.9%` reverse=`0.0%` hold=`47419` sec median_margin=`157649.68`
- Issues: none
- Position comparison:
...
- Poll status: `pass`; age=`5.8` sec; new orders=`0`
- Warmup: `existing_history`; sync-open: `-`; pending=`False`
- Latest source event: `ETHUSDT close_long @ 2026-03-15 13:18:01`
- Latest copy order: `ETHUSDT close skipped @ 2026-03-15 13:43:34`
- Dynamic sizing: score=`64` clip=`35.2%` reverse=`6.2%` hold=`74696` sec median_margin=`1089.98`
- Issues:
...
- Poll status: `pass`; age=`7.4` sec; new orders=`0`
- Warmup: `existing_history`; sync-open: `-`; pending=`False`
- Latest source event: `BTCUSDT close_long @ 2026-03-13 23:40:31`
- Latest copy order: `- - - @ -`
- Dynamic sizing: score=`47` clip=`62.5%` reverse=`0.0%` hold=`569146` sec median_margin=`2704.56`
- Issues:
...
- Poll status: `pass`; age=`4.1` sec; new orders=`0`
- Warmup: `existing_history`; sync-open: `-`; pending=`False`
- Latest source event: `ETHUSDT close_short @ 2026-03-15 04:41:21`
- Latest copy order: `- - - @ -`
- Dynamic sizing: score=`20` clip=`0.0%` reverse=`0.0%` hold=`0` sec median_margin=`0.0`
- Issues: none
- Position comparison:
  - no active source/local positions
- Recent copy orders:
...
- Poll status: `pass`; age=`5.0` sec; new orders=`0`
- Warmup: `existing_history`; sync-open: `-`; pending=`False`
- Latest source event: `COLLECTUSDT open_long @ 2026-03-14 03:13:31`
- Latest copy order: `- - - @ -`
- Dynamic sizing: score=`45` clip=`0.0%` reverse=`100.0%` hold=`3421` sec median_margin=`614.56`
- Issues:
